...
| Evidence files | Built end to end on Cloudflare R2 and verified from the browser on 15 September 2026 (6.5 MB photograph → 232 KB); the bucket's CORS rule names `http://localhost:5173` only — **the production origin still has to be added** (OQ-49) |
