...
`attachment` has **zero rows**. The R2 path is built but not configured — four secrets and a bucket CORS rule outstanding (**OQ-49**).
...
4. Configure R2 — four secrets and the bucket CORS rule (OQ-49)
